export class TrieTreeNode {
    ...
    constructor(character?: string) {
        ...
        this.character = character ? character.toLowerCase() : undefined;
    ...
    hasChild(character: string): boolean {
        ...
        return this.children.has(character.toLowerCase());
    }
    ...
    getChild(character: string): TrieTreeNode {
        ...
        if (this.hasChild(character.toLowerCase())) {
            return this.children.get(character.toLowerCase())!;
        }
    ...
    addChild(character: string, child_node: TrieTreeNode): void {
        ...
        if (!this.hasChild(character.toLowerCase())) {
            this.children.set(character.toLowerCase(), child_node)
        } else {
